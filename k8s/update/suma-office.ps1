param(
    [string]$Namespace = 'suma-office',
    [string]$DeploymentName = 'suma-office',
    [string]$ImageName = 'suma-office',
    [string]$Version = 'v1.0.0',
    [switch]$NoCache,
    [switch]$NonInteractive
)

Write-Host "=== Suma Office: Build & Redeploy ===" -ForegroundColor Green
...
function Get-Paths {
    ...
    $dockerfile = Join-Path $serviceRoot 'dockerfile.web'
...
Apply-OfficeStack -Ns $Namespace -Dir $paths.Manifests
